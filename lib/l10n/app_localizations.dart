...
abstract class AppLocalizations {
  ...
  /// No description provided for @noMoods.
  ///
  /// In en, this message translates to:
  /// **'No mood entries yet'**
  String get noMoods;
  ...
  /// No description provided for @noMoodsToday.
  ///
  /// In en, this message translates to:
  /// **'No moods recorded today'**
  String get noMoodsToday;

  /// No description provided for @addFirstMood.
  ///
  /// In en, this message translates to:
